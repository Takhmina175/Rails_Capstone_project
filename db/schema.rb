...
ActiveRecord::Schema.define(version: 2021_06_27_180212) do
  ...
  create_table "articles_category_lists", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["article_id"], name: "index_articles_category_lists_on_article_id"
    t.index ["category_id"], name: "index_articles_category_lists_on_category_id"
  end
